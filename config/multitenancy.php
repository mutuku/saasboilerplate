...
return [
     ...
     */
    'tenant_database_connection_name' => 'saas',
    ...
    /*Disable subdomain-based tenant identification since you’re not using subdomains:*/
    'identify_tenant_middleware_fqcn' => \App\Http\Middleware\IdentifyTenant::class,
